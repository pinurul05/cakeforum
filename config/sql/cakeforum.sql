...
CREATE TABLE `forum_categories` (
  ...
  `last_topic_subject` varchar(150) collate utf8_unicode_ci DEFAULT NULL,
  `last_topic_created` datetime,
  `last_topic_user_id` varchar(36)  DEFAULT NULL,
  `last_topic_username` varchar(64) collate utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `forum_posts` (
  ...
  `approve` tinyint(1) collate utf8_unicode_ci DEFAULT 1,
  PRIMARY KEY  (`id`),
